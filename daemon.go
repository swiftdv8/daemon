...
func New(name, description string, params []string, dependencies ...string) (Daemon, error) {
	return newDaemon(strings.Join(strings.Fields(name), "_"), description, params, dependencies)
}
